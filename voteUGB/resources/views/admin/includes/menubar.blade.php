<aside class="main-sidebar">
  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li class=""><a href="{{route('admin.dashboardAdmin')}}"><i class="fa fa-dashboard"></i> <span>Dashboard</span></a></li>
      ...
      <li class=""><a href="positions.php"><i class="fa fa-tasks"></i> <span>Postes</span></a></li>
      <li class=""><a href="candidates.php"><i class="fa fa-black-tie"></i> <span>Candidats</span></a></li>
