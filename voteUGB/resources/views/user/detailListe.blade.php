        ...
        <div id="page-content-wrapper m-3 ">
            ...
            <div class=" container-fluid  mx-auto my-auto">
                <div class="col m-3 p-3">
                    <h1 class="mt-4">Titre du programme: <span class="name-list fw-bold ">Sama list </span> </h1>
                    <p class="fw-bold text-primary slogan">The slogan </p>
                    <p class="text-programme mx-auto my-auto">
